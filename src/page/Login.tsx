    ...
    return (
        <div className="flex justify-center items-center h-screen">
            <div className="flex flex-col justify-between align-middle items-center h-64 w-72 py-5 bg-[#2D2D2D] rounded-xl">
                ...
                <div onClick={loginWithGoogle} className="flex justify-center items-center cursor-pointer bg-blue-600 hover:bg-blue-700 transition-all align-middle w-full h-16">
